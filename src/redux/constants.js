//export const BASE_URL = "https://www.mteducare.com/mt-educare-admin/public/api";
export const BASE_URL = "http://127.0.0.1:8000/api";
//export const IMAGE_BASE_URL = "http://127.0.0.1:8000/storage/";
export const IMAGE_BASE_URL = "https://www.mteducare.com/mt-educare-admin/public/storage/";
...
export const MEETING_DATA = `${BASE_URL}/meeting-data-list/`;

// Report Data  api
export const REPORT_DATA = `${BASE_URL}/report-data-list/`;

// Annual Report Data  api
export const ANNUAL_REPORT_DATA = `${BASE_URL}/annual-report-data-list`;

//Annual Return Data
export const ANNUAL_RETURN_DATA = `${BASE_URL}/annual-return-data-list`;
...
//Invester search api
export const INVESTOR_SEARCH_API = `${BASE_URL}/invester-search`;

//Report search api
export const REPORT_SEARCH_API = `${BASE_URL}/report-search`;

//Return search api
export const RETURN_SEARCH_API = `${BASE_URL}/return-search`;
